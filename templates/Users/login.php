    ...
    <div class="column column-50">
        ...
        ">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <h2 style="font-weight: 800; color: #444; margin-bottom: 5px;">LOGIN</h2>
                <p style="color: #888; font-size: 1.1rem;">Por favor, ingresa tus credenciales</p>
            </div>
            ...
            <fieldset style="border: none; padding: 0;">
                <div style="margin-bottom: 20px;">
                    <label style="font-weight: bold; color: #555; text-transform: uppercase; font-size: 0.8rem;">
                        <i class="dash"></i> Correo Electrónico
                    </label>
                    <?= $this->Form->control('correo', [
                        'label' => false, 
                        'required' => true,
                        'placeholder' => 'usuario@dominio.com',
                        'style' => 'height: 50px; border-radius: 8px; border: 1px solid #ddd; padding-left: 15px;'
                    ]) ?>
                </div>
        ...
        <p style="text-align: center; margin-top: 20px; color: #aaa; font-size: 0.8rem;">
            &copy; <?= date('Y') ?> Marvin - Proyecto Final Sistemas
        </p>
    </div>
